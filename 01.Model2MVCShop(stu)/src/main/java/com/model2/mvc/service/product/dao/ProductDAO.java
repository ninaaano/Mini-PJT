...
public class ProductDAO {
	...
	public void insertProduct(ProductVO productVO) throws Exception {
		...
		stmt.setString(1, productVO.getFileName()); // 5
		stmt.setString(2, productVO.getManuDate().replace("-", "")); //3
		stmt.setInt(3, productVO.getPrice()); //4
		stmt.setString(4, productVO.getProdDetail()); // 2
		stmt.setString(5, productVO.getProdName()); // 1
...
public HashMap<String,Object> getProductList(SearchVO searchVO) throws Exception {
		...
		if (total > 0) {
			for (int i = 0; i < searchVO.getPageUnit(); i++) {
				...
				vo.setManuDate(rs.getString("manuDate"));
